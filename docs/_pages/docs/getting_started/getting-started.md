...
To get started with Regolith, you should first read our [introduction](/docs/getting-started/introduction) page, and the [installation](/docs/getting-started/installation) page.
